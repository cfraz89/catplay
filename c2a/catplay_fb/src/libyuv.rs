...
unsafe extern "C" {
    ...
    pub fn calc_frame_psnr(src_a: *const u8, stride_a: c_int, src_b: *const u8, stride_b: c_int, width: c_int, height: c_int) -> c_double;
    ...
    pub fn calc_frame_ssim(src_a: *const u8, stride_a: c_int, src_b: *const u8, stride_b: c_int, width: c_int, height: c_int) -> c_double;
    ...
    #[link_name = "I400Copy"]
    pub fn i400_copy(src_y: *const u8, src_stride_y: c_int, dst_y: *const u8, dst_stride_y: c_int, width: c_int, height: c_int) -> c_int;
    ...
    #[link_name = "MJPGSize"]
    pub fn mjpg_size(sample: *const u8, sample_size: usize, width: *const c_int, height: *const c_int) -> c_int;
    ...
    #[link_name = "CopyPlane"]
    pub fn copy_plane(src_y: *const u8, src_stride_y: c_int, dst_y: *const u8, dst_stride_y: c_int, width: c_int, height: c_int);

    #[link_name = "CopyPlane_16"]
    pub fn copy_plane_16(src_y: *const u16, src_stride_y: c_int, dst_y: *const u16, dst_stride_y: c_int, width: c_int, height: c_int);
    ...
    #[link_name = "SetPlane"]
    pub fn set_plane(dst_y: *const u8, dst_stride_y: c_int, width: c_int, height: c_int, value: u32);
    ...
    pub fn swap_uv_plane(src_uv: *const u8, src_stride_uv: c_int, dst_vu: *const u8, dst_stride_vu: c_int, width: c_int, height: c_int);
    ...
    pub fn i400_to_i400(src_y: *const u8, src_stride_y: c_int, dst_y: *const u8, dst_stride_y: c_int, width: c_int, height: c_int)
    -> c_int;
    ...
    pub fn i400_mirror(src_y: *const u8, src_stride_y: c_int, dst_y: *const u8, dst_stride_y: c_int, width: c_int, height: c_int) -> c_int;
    ...
    pub fn mirror_plane(src_y: *const u8, src_stride_y: c_int, dst_y: *const u8, dst_stride_y: c_int, width: c_int, height: c_int);

    #[link_name = "MirrorUVPlane"]
    pub fn mirror_uv_plane(src_uv: *const u8, src_stride_uv: c_int, dst_uv: *const u8, dst_stride_uv: c_int, width: c_int, height: c_int);
    ...
    #[link_name = "ARGBGray"]
    pub fn argb_gray(dst_argb: *const u8, dst_stride_argb: c_int, dst_x: c_int, dst_y: c_int, width: c_int, height: c_int) -> c_int;

    #[link_name = "ARGBSepia"]
    pub fn argb_sepia(dst_argb: *const u8, dst_stride_argb: c_int, dst_x: c_int, dst_y: c_int, width: c_int, height: c_int) -> c_int;
    ...
    pub fn byte_to_float(src_y: *const u8, dst_y: *const c_float, scale: c_float, width: c_int) -> c_int;
    ...
    pub fn argb_affine_row_c(src_argb: *const u8, src_argb_stride: c_int, dst_argb: *const u8, uv_dudv: *const c_float, width: c_int);

    #[link_name = "ARGBAffineRow_SSE2"]
    pub fn argb_affine_row_sse2(src_argb: *const u8, src_argb_stride: c_int, dst_argb: *const u8, uv_dudv: *const c_float, width: c_int);
    ...
    pub fn rotate_plane90(src: *const u8, src_stride: c_int, dst: *const u8, dst_stride: c_int, width: c_int, height: c_int);

    #[link_name = "RotatePlane180"]
    pub fn rotate_plane180(src: *const u8, src_stride: c_int, dst: *const u8, dst_stride: c_int, width: c_int, height: c_int);

    #[link_name = "RotatePlane270"]
    pub fn rotate_plane270(src: *const u8, src_stride: c_int, dst: *const u8, dst_stride: c_int, width: c_int, height: c_int);
    ...
    pub fn transpose_plane(src: *const u8, src_stride: c_int, dst: *const u8, dst_stride: c_int, width: c_int, height: c_int);
    ...
    pub fn j400_to_j400(src_y: *const u8, src_stride_y: c_int, dst_y: *const u8, dst_stride_y: c_int, width: c_int, height: c_int)
    -> c_int;
